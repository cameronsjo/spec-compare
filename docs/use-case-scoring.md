...
Numeric scores (1–5) for quick visual comparison across all 19 tracked tools (re-verified 2026-07-23, see [reassessment](reassessment-2026-07-23.md); Memex assessed 2026-08-12, see [its review](memex-review.md)). Includes the additional frameworks from the [gaps analysis](gaps.md).
...
MoAI-ADK v3          2        4       4      4         1          3     4             3.1
Frame                3        3       3      4         2          3     3             3.0
GRACE                1        3       4      2         1          2     3             2.3
GAAI                 2        3       4      3         1          2     4             2.7
