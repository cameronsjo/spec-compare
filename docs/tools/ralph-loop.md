...
- **smart-ralph** — Spec-driven workflow that transforms feature requests into structured specs then executes them task-by-task autonomously. Now tracked as its own emerging entry in this comparison (July 2026)
